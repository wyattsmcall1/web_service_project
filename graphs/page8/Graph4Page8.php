...
<?php  
 ...
 // Dataset definition   
 $DataSet = new pData;   
 $DataSet->AddPoint(array(.5,.5,.7),"Serie2");    
 $DataSet->AddAllSeries();  
 $DataSet->SetAbsciseLabelSerie();  
 $DataSet->SetSerieName("Female","Serie2");  
 $DataSet->AddPoint(array('Pregnant','Not Pregnant', 'Unknown'),"XLABEL"); 
 ...
 $Test->Render("Graph4Page8.png");  

print "<img src=\"Graph4Page8.png\" />";
?>  

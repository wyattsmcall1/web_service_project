...
<?php  
 ...
 // Dataset definition   
 $DataSet = new pData;  
 $DataSet->AddPoint(array(.8,1.6,.8),"Serie1");  
 $DataSet->AddPoint(array(.3,.5,.5),"Serie2");  
 $DataSet->AddPoint(array(.5,.9,.6),"Serie3");  
 $DataSet->AddPoint(array('Current Smoker','Not Current Smoker','Unknown'),"XLABEL"); 
 ...
 $Test->Render("Graph2Page8.png");  

print "<img src=\"Graph2Page8.png\" />";
?>  
